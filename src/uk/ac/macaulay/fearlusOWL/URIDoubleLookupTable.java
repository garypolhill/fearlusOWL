 ...
 * @author Gary Polhill
 */
public class URIDoubleLookupTable extends LookupTable<URI, Double[]> {
  /**
   ...
   */
  public URIDoubleLookupTable(Table<String> table) throws URISyntaxException {
   ...
   * @throws URISyntaxException
   */
  public URIDoubleLookupTable(Table<String> table, String prefix) throws URISyntaxException {
   ...
   * @throws URISyntaxException
   */
  public URIDoubleLookupTable(Table<String> table, int noutcome) throws URISyntaxException {
    this(table, "", noutcome);
  }
   ...
   * @throws URISyntaxException
   */
  public URIDoubleLookupTable(Table<String> table, String prefix, int noutcome) throws URISyntaxException {
    ...
    outcome2id = new HashMap<URI, Integer>();
    ...
    for(int row = 1; row < table.nrows(); row++) {
      URI[] input = makeURIs(prefix, table.atrc2c(row, 0, table.ncols() - (noutcome + 1)).toArray(new String[0]));
      Double[] outcome =
   ...
   * @throws URISyntaxException
   */
  public URIDoubleLookupTable(String csvFileName) throws IOException, CSVException, URISyntaxException {
   ...
   * @throws URISyntaxException
   */
  public URIDoubleLookupTable(String csvFileName, int noutcome) throws IOException, CSVException, URISyntaxException {
   ...
   * @throws URISyntaxException
   */
  public URIDoubleLookupTable(String csvFileName, String prefix) throws IOException, CSVException, URISyntaxException {
   ...
   * @throws URISyntaxException
   */
  public URIDoubleLookupTable(String csvFileName, String prefix, int noutcome) throws IOException, CSVException,
      URISyntaxException {
  ...
  public Set<URI> getInputs(URI label) {
    return getInputs(label.toString());
  }
  ...
  public Double[] lookupURI(Map<URI, URI> input) {
    Map<String, URI> labelInput = new HashMap<String, URI>();
...
//      }
      labelInput.put(keystr, input.get(key));
    }
  ...
  public double lookup(URI outcomeLabel, URI... input) {
    Double[] outcome = lookup(input);
    if(outcome2id == null) {
      throw new RuntimeException("Outcomes are not labelled!");
    }
    if(!outcome2id.containsKey(outcomeLabel)) {
      throw new RuntimeException("Cannot find outcome label " + outcomeLabel + ", options are " + outcome2id.keySet());
    }
  ...
  public double lookup(OWLEntity entity, Map<? extends OWLEntity, OWLIndividual> input) {
    ...
    if(!outcome2id.containsKey(entity.getURI())) {
      throw new RuntimeException("Cannot find outcome label " + entity.getURI() + ", options are " + outcome2id.keySet());
    }
